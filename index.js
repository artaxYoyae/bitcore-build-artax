...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-artax/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-artax -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-artax -o bitcore-lib-artax.js';
    }
